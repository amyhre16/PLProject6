...
# putting a ' in front of the ( tells it that it's not a function
# (car '( 1 2 3 4 5)) gives you the first element
# (cdr '( 1 2 3 4 5)) gives you everything except the first element
# (cons 6 '(1 2 3 4)) takes 6 and puts it at the front of the list
# (+ 4 (car '(1 2 3 4)))
#           adds 4 to the 1 returned by car